...
// função para criação dos elementos
    ...
    {   
        ...
        const healthWidth = 400;
        const healthHeight = 10;

<<<<<<< HEAD
        this.messerHP = 1000;
        this.messerLifeBackground = this.add.rectangle(0, 0, healthWidth, healthHeight, 0x000000);
        this.messerLife = this.add.rectangle(0, 0, 0.3*this.messerHP, healthHeight, 0xff0000);
        ...
        this.nomeText = this.add.text(0, healthHeight + 5, "Messer Kniffes", { fontFamily: 'comic-sans', fontSize: '16px', color: '#ffffff' });
...
>>>>>>> 81b537479d8f80f20edfdf5bf48b402d40b5d972
